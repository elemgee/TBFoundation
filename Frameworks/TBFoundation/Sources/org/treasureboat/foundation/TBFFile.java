 ...
 * @author David Teran
 */
public class TBFFile extends File {
  /**
   ...
   *        If child is null
   */
  public TBFFile(File parent, String child) {
    super(parent, child);
  }
   ...
   */
  public TBFFile(String pathname) {
    super(pathname);
  }
   ...
   *        If child is null
   */
  public TBFFile(String parent, String child) {
    super(parent, child);
  }
  ...
  public File[] listFiles() {
    ...
    for (int i = 0; i < files.length; i++) {
      files[i] = new TBFFile(files[i].getAbsolutePath());
    }
    return files;
  }
  ...
  public File getAbsoluteFile() {
    ...
    TBFFile f1 = new TBFFile(f.getAbsolutePath());
    return f1;
  }
