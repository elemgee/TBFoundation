 ...
 * @author Marc A. Mnich
 */
public class TBFRandomGUID {
  /** 
   * <a href="http://wiki.wocommunity.org/display/documentation/Wonder+Logging">new org.slf4j.Logger</a> 
   */
  static final Logger log = LoggerFactory.getLogger(TBFRandomGUID.class);
   ...
   */
  public TBFRandomGUID(boolean secure) {
  ...
  public static void main(String args[]) {
    for (int i=0; i< 100; i++) {
      TBFRandomGUID myGUID = new TBFRandomGUID();
  ...
  /**
   * Returns the {@code String} representation of a new {@code TBFRandomGUID}
   * object.
   * 
   * @return 
   *        the {@code String} representation of a new {@code TBFRandomGUID}
   *        object
   */
  public static String newGid() {
    return new TBFRandomGUID().toString();
  }
}
