 ...
 * @author Chuck Hill
 */
public class TBFComparatorSupport {
   ...
   *
   * @param comparator 
   *        NSComparator instance to use if both object1 and object2 are not null/NSKeyValueCoding.NullValue
   * @param object1 
   ...
   *        if comparator throws this comparing object1 to object2
   */
